...
import mariaCover from '../../assets/images/ribs-cover.jpg'; 
import mariaAudio from '../../assets/music/ribs.mp3'; 
// import friendsPhoto from '../../assets/images/polaroid-dia2.jpg'; // Reemplaza con tu foto

const Maria = ({ onGoToNext }) => {
  ...
  return (
    <div className="day4-container fade-in-soft">
      <div className="day4-content">
        <h2 className="day4-title">2 de Agosto — Capítulo II: El miedo a crecer</h2>
        
        <div className="day4-letter">
          {/* Renderizamos los párrafos terminados */}
          {completedParagraphs.map((text, idx) => (
            <p key={idx} className="day4-paragraph fade-in-soft">{text}</p>
          ))}
          {/* Renderizamos el párrafo que se está escribiendo en vivo */}
          {paragraphIndex < paragraphs.length && (
            <p className="day4-paragraph">
              {currentText}
