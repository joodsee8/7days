...
const IndexMenu = () => {
  ...
  const days = [
    ...
    { id: 6, chapter: "Capítulo VI", title: "Long Live", path: "/day6", unlocked: checkUnlocked(30) },
    { id: 7, chapter: "Capítulo VII", title: "Mary", path: "/day7", unlocked: checkUnlocked(30) },
  ];
    ...
    <div className="index-container fade-in">
      <div className="editorial-wrapper">
        <header className="index-header">
          ...
          <h1 className="index-main-title">E U N O I A</h1>
